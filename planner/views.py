...
from planner.models import Assignment, Course
...
def assignments(request):
    ...
    return render(request, "planner/assignments.html", context)
...
def assignment_detail(request, assignment_id):
    try:
        ...
        return HttpResponseRedirect(reverse('planner:assignments'))
    ...
    if assignment.course.user == request.user:
        ...
        return render(request, "planner/single_assignment.html", context)
